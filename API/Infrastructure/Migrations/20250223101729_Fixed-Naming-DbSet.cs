...
{
    /// <inheritdoc />
    public partial class FixedNamingDbSet : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInteractionsLocation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserInteractionsLocation_InteractionTypes_InteractionTypeId",
                        column: x => x.InteractionTypeId,
                        principalTable: "InteractionTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInteractionsLocation_Locations_LocationId",
                        column: x => x.LocationId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInteractionsLocation_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInteractionsLocation_InteractionTypeId",
                table: "UserInteractionsLocation",
                column: "InteractionTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInteractionsLocation_LocationId",
                table: "UserInteractionsLocation",
                column: "LocationId");

            migrationBuilder.CreateIndex(
                name: "IX_UserInteractionsLocation_UserId",
                table: "UserInteractionsLocation",
                column: "UserId");
        }
